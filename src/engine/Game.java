...
public class Game {
	...
	public String getCurrentPlayerName() {
		if(firstPlayer.getTeam().contains(getCurrentChampion()))return firstPlayer.getName();
		else return secondPlayer.getName();
	}
	...
	public void endTurn() {
		turnOrder.remove();
		// i added the if condition inside the while loop 
	...
	private void updateView() {
		listener.updateAll(board, getCurrentChampion(), firstPlayer, secondPlayer, firstLeaderAbilityUsed,
				secondLeaderAbilityUsed, turnOrder);
	}
